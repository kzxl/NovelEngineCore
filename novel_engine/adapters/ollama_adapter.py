...
class OllamaAdapter(BaseLLMAdapter):
    ...
    def _get_compact_schema_instruction(self, model: Type[Any]) -> str:
        if model == UnifiedSceneResponse:
            return '{\n  "scene_title": "Scene Title",\n  "prose_content": "Full narrative story prose...",\n  "key_events": ["Event 1", "Event 2"],\n  "discovered_items": ["Item name"],\n  "discovered_locations": ["Location name"],\n  "discovered_secrets": ["Secret/Clue"],\n  "hp_change": 0,\n  "reputation_change": 10,\n  "luck_change": 5,\n  "ending_cliffhanger": "Cliffhanger hook",\n  "next_fate_choices": [\n    {"title": "Choice 1", "description": "Description of path 1"},\n    {"title": "Choice 2", "description": "Description of path 2"},\n    {"title": "Choice 3", "description": "Description of path 3"}\n  ]\n}'
        elif model == GeneratedCharacterList:
            return '{\n  "characters": [\n    {\n      "character_id": "char_id",\n      "name": "Character Name",\n      "role": "Protagonist/Antagonist/Mentor/Sidekick",\n      "visual_tags": ["tag1", "tag2"],\n      "personality": {\n        "core_motivation": "Core desire",\n        "fatal_flaw": "Weakness",\n        "moral_boundary": "Ethics line",\n        "hidden_secret": "Secret"\n      },\n      "status": {\n        "power_tier": "Rank 1",\n        "health_condition": "Healthy",\n        "mental_state": "Calm"\n      }\n    }\n  ]\n}'
        elif model == GeneratedEventList:
            return '{\n  "events": [\n    {\n      "event_id": "evt_1",\n      "title": "Event Title",\n      "severity": "Minor / Major / Calamity",\n      "category": "Faction Warfare",\n      "trigger_cause": "Trigger reason",\n      "involved_characters": ["char_1"],\n      "location": "Location Name",\n      "impact_summary": "Impact summary",\n      "suggested_scene_goal": "Scene goal",\n      "suggested_conflict": "Main conflict",\n      "suggested_cliffhanger": "Ending hook"\n    }\n  ]\n}'
        elif model == WorldBible:
            return '{\n  "world_id": "world_1",\n  "title": "World Title",\n  "genre": "Xianxia",\n  "era_setting": "Ancient Era",\n  "energy_source": "Spiritual Qi",\n  "canon_rules": ["Rule 1", "Rule 2"],\n  "factions": [{"name": "Faction Name", "alignment": "Righteous", "core_doctrine": "Cultivate Dao"}],\n  "locations": [{"name": "Location Name", "climate_and_vibe": "Mystic", "key_hazards": "Ancient Beasts"}]\n}'
        elif model == WorldExpansionResult:
            return '{\n  "new_factions": [{"name": "New Faction", "alignment": "Neutral", "core_doctrine": "Guard Domain"}],\n  "new_locations": [{"name": "Forbidden Area", "climate_and_vibe": "Foggy", "key_hazards": "Ancient Traps"}],\n  "new_canon_rules": ["New rule"]\n}'
        return "{}"
